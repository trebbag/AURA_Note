...
const requiredSnippets = [
  ...
  ['apps/web/app/aura-note/ai-governance/page.tsx', 'External AI', 'visible external AI disabled posture'],
  ['apps/web/app/aura-note/ai-governance/page.tsx', 'live external AI remains disabled', 'visible live model disabled posture'],
...
const hasAdvancedBeyondAiGovernanceTranche =
  status.next_work_order === null || (Number.isFinite(nextWorkOrderNumber) && nextWorkOrderNumber >= 47);
if (!hasAdvancedBeyondAiGovernanceTranche || status.work_orders?.['WO-046'] !== 'done') {
