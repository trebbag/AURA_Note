...
check('status.post-p11-checkpoint', 'Current checkpoint remains P11 or commercial-readiness work', ['P11', 'CR-0', 'CR-1', 'CR-2', 'CR-3', 'CR-4'].includes(status.current_checkpoint), status.current_checkpoint);
