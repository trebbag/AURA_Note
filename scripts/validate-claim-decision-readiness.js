...
check('status.post-p11-next-work-order', 'Post-P11 decision gate remains safe while commercial-readiness runtime work is active', status.next_work_order === null || status.next_work_order === 'WO-061' || status.next_work_order === 'WO-062', status.next_work_order);
