...
check('status.post-p11-next-work-order', 'Post-P11 decision gate remains safe while commercial-readiness runtime work is active', status.next_work_order === null || status.next_work_order === 'WO-061' || status.next_work_order === 'WO-062' || status.next_work_order === 'WO-063', status.next_work_order);
check('status.post-p11-checkpoint', 'Current checkpoint remains P11 or commercial-readiness work', status.current_checkpoint === 'P11' || status.current_checkpoint === 'CR-0' || status.current_checkpoint === 'CR-1', status.current_checkpoint);
