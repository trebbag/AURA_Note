...
check('status.next-null', 'No next work order is active after WO-056 planning/control completion', status.next_work_order === null || status.next_work_order === 'WO-061', status.next_work_order);
