...
const hasAdvancedBeyondClinicOsTranche =
  status.next_work_order === null || (Number.isFinite(nextWorkOrderNumber) && nextWorkOrderNumber >= 46);
if (!hasAdvancedBeyondClinicOsTranche || status.work_orders?.['WO-045'] !== 'done') {
