...
check('status.p10-or-commercial-readiness', 'repo_status current checkpoint advances to P10/P11 or commercial-readiness work after P9 completion', ['P10', 'P11', 'CR-0', 'CR-1', 'CR-2', 'CR-3', 'CR-4'].includes(status.current_checkpoint), status.current_checkpoint);
