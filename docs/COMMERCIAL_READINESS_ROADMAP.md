...
5. `WO-064` converted primary production-intended routes to typed API-backed state and added `pnpm frontend:primary-runtime-readiness`.
6. `WO-065` completes the Figma-ready screen, component, state, workflow, role, data/API, and copy inventory.
